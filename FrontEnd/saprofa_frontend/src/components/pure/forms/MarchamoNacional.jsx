...
const marchamoSchema = Yup.object().shape({
  ...
  aperturaP: Yup.number().required('El campo es requerido').max(9999, 'El número debe ser de 4 dígitos').min(1, 'El número no puede ser menor que 0'),
  cierreP: Yup.number().required('El campo es requerido').max(9999, 'El número debe ser de 4 dígitos').min(1, 'El número no puede ser menor que 0'),
