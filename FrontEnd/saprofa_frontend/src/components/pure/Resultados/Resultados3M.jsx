...
const Resultados3M = ({ numSorteo, idInterno }) => {
    ...
    const validateNumber = (numero) => {
        ...
        //If the number has more or less than 2 digits
            ...
            return 'El número solo debe tener 1 dígito';
        }
        ...
        if (resultados.length === 3) {
            return 'Ya se han registrado los 3 números ganadores';
        }
                        ...
                        <Form >
                            <div className="row">
                                <table className="table table-bordered align-middle mt-5 col">
                                    <thead>
                                        <tr>
                                            <th colSpan={2}>Resultados del Sorteo de 3 Monazos No. {numSorteo}
