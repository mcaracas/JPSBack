...
function validateNumber(value) {
  ...
  } else if (!/^([0-9]|[1-3][0-9]|40|0[0-9])$/.test(value)) {
    error = 'Debe ser un número entre 00 y 40';
  }
  return error;
}

const PruebasLottoForm = () => {
...
export default PruebasLottoForm;
