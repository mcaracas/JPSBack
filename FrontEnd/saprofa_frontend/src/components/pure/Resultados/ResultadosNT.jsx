...
const ResultadosNT = ({ numSorteo, idInterno }) => {
    ...
    const validateNumber = (numero) => {
        ...
        //If the number is not between 0 and 99
        ...
        if (resultados.length === 1) {
            return 'Ya se ha registrado el número ganador';
        }
    ...
    async function handleSubmit() {
        try {
            const data = {
                ...
                "NumFavorecido": resultados[0].numero,
                "Verificado": false,
            ...
            alert("Ingreso de resultado fallido. Intente de nuevo.");
        }
    }
                        ...
                        <Form >
                            <div className="row">
                                <table className="table table-bordered align-middle mt-5 col">
                                    <thead>
                                        <tr>
                                            <th colSpan={2}>Resultados del Sorteo de Nuevos Tiempos No. {numSorteo}
